...
def check_files():
    ...
    required_files = [
        ...
        'PUBLISHING.md',
        'loglens/__init__.py',
        'loglens/core/__init__.py',
        'loglens/core/parser.py',
        'loglens/core/analyzer.py',
        'loglens/integrations/__init__.py',
        'loglens/integrations/fastapi_integration.py',
        'loglens/integrations/flask_integration.py',
        'loglens/visualizers/__init__.py',
        'loglens/visualizers/charts.py',
        'loglens/visualizers/tables.py',
        'loglens/cli.py',
